// https://mtf.onepay.vn/paygate/api/v1/invoices?merchant_id=TESTONEPAY&merchant_idInvoice=TEST_1551261912692687055259&state=(inexisting|processing|unpaid|completed)

const _host_dev = 'http://dev.onepay.local';
const _url_get_detail = '/paygate/api/v1/invoice_detail/';
